...
interface TransferFromSelectorProps {
...
export function TransferFromSelector({
  value,
  coin,
  balance,
  onChange,
  disabled,
}: TransferFromSelectorProps) {
  const selected = ACCOUNT_OPTIONS.find((opt) => opt.value === value);
