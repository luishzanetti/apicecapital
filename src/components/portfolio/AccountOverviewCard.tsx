        ...
        <CardContent className="pt-4 pb-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="rounded-xl bg-primary/5 border border-primary/10 p-3">
              <p className="text-[10px] text-muted-foreground uppercase tracking-wider mb-1">Unified Account</p>
              <p className="text-sm font-bold">{fmt(totalEquity)}</p>
            </div>

            {/* Funding Account */}
            <div className="rounded-xl bg-amber-500/5 border border-amber-500/10 p-3">
              <p className="text-[10px] text-amber-400 uppercase tracking-wider mb-1">Funding Account</p>
            ...
            <div className={cn(
              ...
              <p className="text-[10px] text-muted-foreground uppercase tracking-wider mb-1">Unrealized P&L</p>
              ...
              <p className={cn('text-[10px] mt-0.5', pnlPositive ? 'text-green-400/70' : 'text-red-400/70')}>
