  ...
  return (
    <header className="relative z-20 w-full">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-6 md:px-10">
        <a href="#" className="group flex items-center gap-3" aria-label="Apice home">
          <TriangleMark
            variant="circle"
            size={44}
      ...
      <div className="mx-auto max-w-7xl">
        ...
        >
          ...
          >
            ...
            New · Global AI Investing is live for early users
          ...
          >
            ...
            <span
              ...
              style={{
                backgroundImage:
                  "linear-gradient(135deg, hsl(var(--apice-blue-glow)) 0%, hsl(var(--apice-emerald)) 100%)",
              }}
            >
              One Week at a Time.
            </span>
          ...
          >
            Wealth is a discipline, not an event. Apice combines AI-driven trading with
            automated DCA savings — so you compound week after week, without the burnout
            of manual decisions. Non-custodial. 24/7. Yours to control.
          </motion.p>
